...
import { Plus, Trash2, Edit2, Users, X, Sprout, TrashIcon } from 'lucide-react'
        ...
        <div className="min-h-screen bg-white">
            <main className="max-w-screen-2xl mx-auto px-4 sm:px-4 lg:px-8 xl:px-12 py-2 lg:py-8 flex flex-col gap-10 font-sans text-[#262626]">
                <div className="max-w-6xl mx-auto w-full space-y-8">
                    {/* Header (Dashboard language) */}
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                        <div>
                            <p className="text-xs font-semibold tracking-widest text-green-600 uppercase mb-1">Management</p>
                            <h1 className="text-3xl font-bold tracking-tight text-[#262626]">Fields</h1>
                            <p className="text-sm text-[rgba(38,38,38,0.45)] mt-0.5">Manage field locations, size, crop, and assigned farmers</p>
                        </div>
                    ...
                    {/* Divider */}
                    <div className="h-px w-full bg-[#2626260F]" />

                    {/* Mobile Cards (keep as-is) */}
                    ...
                    <div className="hidden lg:block">
                        <div className="flex items-center justify-between py-4">
                            <h2 className="text-sm font-semibold text-[#262626]">Field Records</h2>
                        </div>

                        <div className="h-px w-full bg-[#2626260F]" />

                        {/* Replace your existing "card/table wrapper" with this flat wrapper */}
                            ...
                            <thead>
                              <tr>
                                {['Field', 'Area', 'Crops', 'Farmers', 'Status', ''].map((col, i) => (
                                    <th
                                        key={i}
                                        className="px-6 py-3.5 text-left text-xs font-semibold text-[rgba(38,38,38,0.45)] uppercase tracking-wider"
                                    >
                                        {col}
                                    </th>
                                ))}
                        ...
                        {/* keep your existing empty state if any, but remove card wrapper */}
